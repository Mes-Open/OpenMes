...
docker exec openmes-backend php artisan tinker --execute="\DB::table('system_settings')->where('key', 'lot_tracking_enabled')->update(['value' => 'true']);"
set E2E_BASE_URL=http://localhost:8080
npx playwright test tests/e2e/car-production-buildout-en.spec.ts --project=chromium --headed
