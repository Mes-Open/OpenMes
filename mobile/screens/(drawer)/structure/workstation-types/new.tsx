/**
 * New workstation type — re-skinned to the spec form pattern. Mirrors the web
 * admin workstation-type form (Code / Name / Description / Active). Hook,
 * payload and navigation are unchanged.
 */
...
export function NewWorkstationTypeScreen() {
  ...
  const m = useCreateWorkstationType();
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <Text style={styles.h1}>{t('New workstation type')}</Text>
