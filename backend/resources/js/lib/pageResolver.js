 ...
 * repository's modules/ directory. Both maps are produced by `import.meta.glob`
 * in app.jsx; a glob that matches nothing yields {}, so an install with no
 * modules simply passes an empty second map.
 *
