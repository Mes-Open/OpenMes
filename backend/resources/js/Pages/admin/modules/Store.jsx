    ...
    return (
        <>
            ...
            <div className="max-w-3xl mx-auto">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-om-ink">Module Store</h1>
                    <p className="text-om-muted mt-1">Browse and install ready-made OpenMES modules</p>
                </div>
                ...
                <div className="card text-center py-20">
                    ...
                    <h2 className="text-2xl font-bold text-om-muted mb-2">Coming Soon</h2>
