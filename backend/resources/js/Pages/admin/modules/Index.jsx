...
export default function ModulesIndex() {
    ...
    function handleDestroy(name, displayName) {
        if (confirm(__('Uninstall module :name? Files will be removed.', { name: displayName }))) {
        ...
        <>
            ...
            <div className="max-w-5xl mx-auto">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800 dark:text-white">{__('Installed Modules')}</h1>
                        <p className="text-gray-600 dark:text-gray-400 mt-1">{__('Enable and disable installed OpenMES extensions')}</p>
                    </div>
                ...
                {modules.length === 0 ? (
                    <div className="card text-center py-16">
                        ...
                        <p className="text-gray-500 text-lg font-medium">{__('No modules installed')}</p>
                        ...
                        {modules.map((module) => (
                            ...
                            >
                                ...
                                {module.hooks && module.hooks.length > 0 && (
                                    <div>
                                        <p className="text-xs text-gray-400 mb-1">{__('Used hooks')}</p>
