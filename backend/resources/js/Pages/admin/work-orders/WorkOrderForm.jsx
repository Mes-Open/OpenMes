...
export default function WorkOrderForm({ lines = [], productTypes = [], customers = [], bomTemplates = [], customFields = [], cancelHref, onCancel, onSuccess, stay = false, initial = {} }) {
    return (
        <ResourceForm
            action="/admin/work-orders"
            method="post"
            fields={woFields(lines, productTypes, { customers, bomTemplates })}
