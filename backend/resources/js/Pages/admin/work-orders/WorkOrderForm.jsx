...
export const WO_FORM_INITIAL = {
    order_no: '', customer_order_no: '', line_id: '', product_type_id: '',
    planned_qty: '', priority: 0, due_date: '', description: '', custom_fields: {},
};
...
export default function WorkOrderForm({ lines = [], productTypes = [], customFields = [], cancelHref, onCancel, onSuccess, stay = false, initial = {} }) {
    return (
        <ResourceForm
