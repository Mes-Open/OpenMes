...
export default function WorkOrderCreate() {
    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            <WorkOrderForm lines={lines} productTypes={productTypes} customers={customers} bomTemplates={bomTemplates} productRevisions={productRevisions} customFields={customFields} cancelHref="/admin/work-orders" />
        </div>
    );
}
