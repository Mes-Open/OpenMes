        ...
        <form onSubmit={submit} className="space-y-6">
            <Section title="General">
                ...
                <label className="flex items-center gap-3 text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    Active (gateway subscribes on start)
                </label>
            </Section>

            <Section title="Endpoint">
                <Field label="Endpoint URL" required error={errors.endpoint_url}>
                ...
                <Field label="Publishing interval (ms)" required error={errors.publishing_interval_ms}>
            ...
            <Section title="Security">
                <div className="grid grid-cols-2 gap-4">
                    <Field label="Security policy" required error={errors.security_policy}>
                    ...
                    <Field label="Security mode" required error={errors.security_mode}>
                ...
                <Field label="Authentication" required error={errors.auth_mode}>
