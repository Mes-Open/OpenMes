...
export default function OpcuaShow() {
    ...
    return (
        <>
            <Head title={`${connection.name} — OPC UA`} />
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <StatCard value={opcua?.security_policy ?? '—'} label={`Mode: ${opcua?.security_mode ?? '—'}`} />
                    <StatCard value={opcua?.auth_mode ?? '—'} label="Authentication" capitalize />
                </div>
