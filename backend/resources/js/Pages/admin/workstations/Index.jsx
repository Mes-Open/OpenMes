        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-om-ink">Workstations</h1>
            ...
            {workstations.length === 0 ? (
                <div className="bg-om-card rounded-om-sm shadow-sm text-center py-12">
                    ...
                    <p className="text-lg font-medium text-om-muted">No workstations yet</p>
                        ...
                        <div key={ws.id} className="bg-om-card rounded-om-sm shadow-sm p-5 hover:shadow-md transition-shadow">
                            <div className="flex items-start justify-between mb-3">
                                <div className="flex-1">
                                    ...
                                    {ws.workstation_type && (
                                        <p className="text-xs text-om-muted mt-1">Type: {ws.workstation_type}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="mb-4 p-3 bg-om-panel rounded-om-sm grid grid-cols-2 gap-3">
                                <div className="text-center">
                                    ...
                                    <p className="text-xs text-om-muted">Template Steps</p>
                                </div>
                                <div className="text-center">
                                    <p className="text-2xl font-bold text-om-accent">{ws.workers_count}</p>
                                    <p className="text-xs text-om-muted">Workers</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-2 pt-4 border-t border-om-line2">
                                ...
                                {ws.template_steps_count === 0 ? (
                                    ...
                                    <span className="p-2 text-om-faintest" title="Cannot delete — has template steps">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
