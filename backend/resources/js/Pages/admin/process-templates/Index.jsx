            ...
            <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <div className="flex items-center gap-2">
                                <h1 className="text-3xl font-bold text-gray-800">Process Templates</h1>
                            </div>
                ...
                {templates.length > 0 ? (
                                ...
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        {template.steps_count === 0 ? (
                                            ...
                                            <span className="text-gray-300 p-2" title="Cannot delete - has steps">
                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="card text-center py-12">
                        ...
                        <p className="text-lg font-medium text-gray-700">No process templates yet</p>
