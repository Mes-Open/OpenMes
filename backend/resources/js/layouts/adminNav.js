...
export const ADMIN_GROUPS = [
    ...
    },
    {
        ...
        match: [
            ...
            '/admin/skills', '/admin/wage-groups',
        ],
        children: [
    ...
    },
    {
        ...
        label: 'Admin',
        icon: 'shield',
        match: ['/admin/users', '/admin/reports', '/admin/scrap-reports', '/admin/logs', '/admin/audit-logs'],
        children: [
            { label: 'Users', href: '/admin/users', match: ['/admin/users'] },
            { label: 'Reports', href: '/admin/reports', match: ['/admin/reports'], exact: true },
