...
function MaintenanceEventEdit() {
  const { event, scheduled_at = "", scheduled_end_at = "", ...lists } = usePage().props;
  return /* @__PURE__ */ React.createElement("div", { className: "max-w-7xl mx-auto" }, /* @__PURE__ */ React.createElement(Head, { title: __("Edit :name", { name: event.title }) }), /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold text-om-ink mb-6" }, __("Edit Maintenance Event")), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-om-muted mb-4 max-w-2xl" }, __("Select at least one of Tool, Line, or Workstation.")), /* @__PURE__ */ React.createElement(
    ResourceForm,
    {
...
MaintenanceEventEdit.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  MaintenanceEventEdit as default
};
