...
function FactoriesIndex() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Head, { title: __("Factories") }), /* @__PURE__ */ React.createElement(
    ResourceTable,
    {
      shape: "factories",
      title: __("Factories"),
...
FactoriesIndex.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  FactoriesIndex as default
};
