...
function DivisionsIndex() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Head, { title: __("Divisions") }), /* @__PURE__ */ React.createElement(
    ResourceTable,
    {
      shape: "divisions",
      title: __("Divisions"),
...
DivisionsIndex.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  DivisionsIndex as default
};
