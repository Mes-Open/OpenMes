...
function LotSequenceEdit() {
  const { lotSequence } = usePage().props;
  return /* @__PURE__ */ React.createElement("div", { className: "max-w-7xl mx-auto" }, /* @__PURE__ */ React.createElement(Head, { title: __("Edit :name", { name: lotSequence.name }) }), /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold text-om-ink mb-6" }, __("Edit LOT Sequence")), /* @__PURE__ */ React.createElement(
    LotSequenceForm,
    {
...
LotSequenceEdit.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  LotSequenceEdit as default
};
