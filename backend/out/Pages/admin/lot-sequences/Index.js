...
function LotSequencesIndex() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Head, { title: __("LOT Sequences") }), /* @__PURE__ */ React.createElement(
    ResourceTable,
    {
      shape: "lot_sequences",
...
LotSequencesIndex.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  LotSequencesIndex as default
};
