...
function SubassembliesIndex() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Head, { title: __("Subassemblies") }), /* @__PURE__ */ React.createElement(
    ResourceTable,
    {
      shape: "subassemblies",
...
SubassembliesIndex.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  SubassembliesIndex as default
};
