...
function MqttEdit() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Head, { title: `Edit ${connection.name}` }), /* @__PURE__ */ React.createElement("div", { className: "p-6 max-w-2xl" }, /* @__PURE__ */ React.createElement("div", { className: "mb-6" }, /* @__PURE__ */ React.createElement(
    "a",
    {
    ...
    "Back to ",
    connection.name
  ), /* @__PURE__ */ React.createElement("h1", { className: "mt-3 text-2xl font-bold text-om-ink" }, "Edit: ", connection.name)), /* @__PURE__ */ React.createElement(
    MqttConnectionForm,
    {
...
MqttEdit.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  MqttEdit as default
};
