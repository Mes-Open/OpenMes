...
function OpcuaShow() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Head, { title: `${connection.name} \u2014 ${__("OPC UA")}` }), /* @__PURE__ */ React.createElement("div", { className: "p-6 space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement(
    Link,
    {
    ...
    __("Edit")
  )), connection.status_message && /* @__PURE__ */ React.createElement("div", { className: "rounded-om-sm border border-om-line bg-om-blocked-bg px-4 py-3 text-sm text-om-blocked" }, connection.status_message), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-4" }, /* @__PURE__ */ React.createElement(StatCard, { value: connection.tags.length, label: __("Tags") }), /* @__PURE__ */ React.createElement(StatCard, { value: opcua?.security_policy ?? "\u2014", label: __("Mode: :mode", { mode: opcua?.security_mode ?? "\u2014" }) }), /* @__PURE__ */ React.createElement(StatCard, { value: opcua?.auth_mode ?? "\u2014", label: __("Authentication"), capitalize: true })), /* @__PURE__ */ React.createElement(RuntimePanel, { runtime }), /* @__PURE__ */ React.createElement(
    TagManager,
    {
...
OpcuaShow.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  OpcuaShow as default
};
