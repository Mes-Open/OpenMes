...
function OpcuaIndex() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Head, { title: __("OPC UA Connections") }), /* @__PURE__ */ React.createElement("div", { className: "p-6 space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
    Link,
    {
    ...
    __("All connectivity")
  ), /* @__PURE__ */ React.createElement("h1", { className: "text-2xl font-bold text-om-ink" }, __("OPC UA")), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-om-muted mt-1" }, __("Subscribe to OPC UA nodes via the gateway sidecar and map them to machine signals."))), /* @__PURE__ */ React.createElement(
    Link,
    {
    ...
    __("New Connection")
  )), connections.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "text-center py-16 text-om-faint" }, /* @__PURE__ */ React.createElement("p", { className: "text-sm" }, __("No OPC UA connections defined yet.")), /* @__PURE__ */ React.createElement(Link, { href: "/admin/connectivity/opcua/create", className: "mt-2 inline-block text-om-accent hover:underline text-sm" }, __("Create your first OPC UA connection \u2192"))) : /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4" }, connections.map((conn) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: conn.id,
    ...
    conn.endpoint_url && /* @__PURE__ */ React.createElement("p", { className: "text-xs text-om-faint font-mono truncate", title: conn.endpoint_url }, conn.endpoint_url),
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between text-xs text-om-muted" }, /* @__PURE__ */ React.createElement("span", null, conn.tags_count, " ", conn.tags_count === 1 ? __("tag") : __("tags")), conn.security_policy && /* @__PURE__ */ React.createElement("span", null, conn.security_policy)),
...
OpcuaIndex.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  OpcuaIndex as default
};
