...
function CrewsIndex() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Head, { title: __("Crews") }), /* @__PURE__ */ React.createElement(
    ResourceTable,
    {
      shape: "crews",
      title: __("Crews"),
...
CrewsIndex.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  CrewsIndex as default
};
