...
function WorkerEdit() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "max-w-7xl mx-auto" }, /* @__PURE__ */ React.createElement(Head, { title: __("Edit :name", { name: worker.name }) }), /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold text-om-ink mb-6" }, __("Edit Worker")), /* @__PURE__ */ React.createElement(WorkerForm, { form, crews, wageGroups, personnelClasses, customFields, skills, isEdit: true, onSubmit: submit }));
}
WorkerEdit.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  WorkerEdit as default
};
