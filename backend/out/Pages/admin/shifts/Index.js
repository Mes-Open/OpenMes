...
function ShiftsIndex() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Head, { title: __("Shifts") }), /* @__PURE__ */ React.createElement(
    ResourceTable,
    {
      shape: "shifts",
      title: __("Shifts"),
...
ShiftsIndex.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  ShiftsIndex as default
};
