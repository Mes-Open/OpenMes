...
function LinesIndex() {
  ...
  const actions = (r) => [
    ...
    },
    {
      ...
      variant: "danger",
      onClick: () => {
        if (confirm(__('Delete line ":name"? (only if it has no work orders)', { name: r.name }))) router.delete(`/admin/lines/${r.id}`, { preserveScroll: true });
      }
    }
  ];
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Head, { title: __("Production Lines") }), /* @__PURE__ */ React.createElement(
    ResourceTable,
    {
      shape: "lines_all",
...
LinesIndex.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  LinesIndex as default
};
