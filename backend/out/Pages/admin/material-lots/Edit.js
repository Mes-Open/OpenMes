...
function MaterialLotEdit() {
  const { lot, materials = [], sources = [], statuses = [] } = usePage().props;
  return /* @__PURE__ */ React.createElement("div", { className: "max-w-7xl mx-auto" }, /* @__PURE__ */ React.createElement(Head, { title: `Edit ${lot.lot_number}` }), /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold text-om-ink mb-6" }, __("Edit Material Lot")), /* @__PURE__ */ React.createElement(
    ResourceForm,
    {
...
MaterialLotEdit.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  MaterialLotEdit as default
};
