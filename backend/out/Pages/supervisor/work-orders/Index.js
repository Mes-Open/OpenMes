...
function SupervisorWorkOrdersIndex() {
  ...
  const actions = (r) => {
    ...
    if (TERMINAL.includes(s)) {
      ...
      a.push({ label: "Cancel", variant: "warning", onClick: () => {
...
SupervisorWorkOrdersIndex.layout = (page) => /* @__PURE__ */ React.createElement(AppLayout, null, page);
export {
  SupervisorWorkOrdersIndex as default
};
